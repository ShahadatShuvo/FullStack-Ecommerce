      ...
      <Modal open={open} onClose={handleClose} closeAfterTransition>
        <Fade in={open}>
          <div className="flex justify-center items-center h-screen">
            <div className=" bg-slate-100 p-3 rounded-lg  min-w-[40%] max-w-[60%]">
              <div className="flex">
                <div>
                ...
                <div className="min-w-[40%] flex">
                  <div className="h-full border-l-2 border-gray-400 mx-4"></div>
                  <div className="text-gray-500">
                    <p className="w-full border-b mt-3 pb-2 text-2xl font-semibold">
                      Shipping Address
                    </p>
